...
public class CanalClient
{
    ...
    {
        CanalConnector connector = CanalConnectors.newSingleConnector(new InetSocketAddress("192.168.52.102", 11111), "example", "root", "123456");
        int batchSize = 1;
        int emtyCount = 1;
        try {
            connector.connect();
...
//                    System.out.println("===============无数据=================");
    ...
    public static void dataDetails(List<Column> columns, String logfileName, long logfileOffset, String dbname, String tableName, EventType eventType, int emptyCount,long timestamp) {
        ...
        KafkaUtil.senMsg("canal-29", sendKey, jsonStr);
    }
